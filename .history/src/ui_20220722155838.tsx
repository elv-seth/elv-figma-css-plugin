    ...
    return(
        <div className="stylesheet">
          ...
          <div className="text"> 
            ...
            <p>&ensp;--color-bg-primary:<b className="afterColon"> {dataRef.bg_primary}</p>;</p>
            <p>&ensp;--color-bg-secondary:<b className="afterColon"> {dataRef.bg_secondary}</p>; </p>
            <p>&ensp;--background-page-header:<b className="afterColon">  {dataRef.bg_page_header}</p>; </p>
            <p>&ensp;--background-button-primary<b className="afterColon">  {dataRef.bg_button_primary}</p>; </p>
