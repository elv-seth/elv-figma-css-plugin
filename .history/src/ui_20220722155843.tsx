    ...
    return(
        <div className="stylesheet">
          ...
          <div className="text"> 
            ...
            <p>&ensp;--color-text-primary:<b className="afterColon"> {dataRef.text_primary}</p>; </p>
            <p>&ensp;--color-text-secondary:<b className="afterColon">  {dataRef.text_secondary}</p>;</p>
            <p>&ensp;--color-text-highlight:<b className="afterColon">  {dataRef.text_highlight}</p>;</p>
            <p className = "wrap">&#125;</p>
          </div>
