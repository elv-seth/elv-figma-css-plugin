    ...
    return(
        <div className="stylesheet">
          ...
          <div className="text"> 
            ...
            <p>&ensp;--color-page-bg: <b className="afterColon"> {dataRef.bg_page} </p>; </p>
            <p>&ensp;--color-bg-primary:<p className="afterColon"> {dataRef.bg_primary}</p>;</p>
            <p>&ensp;--color-bg-secondary:<p className="afterColon"> {dataRef.bg_secondary}</p>; </p>
            <p>&ensp;--background-page-header:<p className="afterColon">  {dataRef.bg_page_header}</p>; </p>
            <p>&ensp;--background-button-primary<p className="afterColon">  {dataRef.bg_button_primary}</p>; </p>
            <p>&ensp;--color-text-primary:<p className="afterColon"> {dataRef.text_primary}</p>; </p>
            <p>&ensp;--color-text-secondary:<p className="afterColon">  {dataRef.text_secondary}</p>;</p>
            <p>&ensp;--color-text-highlight:<p className="afterColon">  {dataRef.text_highlight}</p>;</p>
            <p className = "wrap">&#125;</p>
          </div>
