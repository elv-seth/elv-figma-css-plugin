...
function App() {
  ...
  const [codeString,setCodeString] = useState("");
   ...
   const saveData = (data) => {
    ...
    temp += "--border-background-card: " + data.border + ";\n";
    ...
    return(
        <div className="stylesheet">
          ...
          <div className="text"> 
            ...
            <p>&ensp;--border-background-card:<b className="afterColon">{dataRef.text_highlight};</b></p>
            <p>&ensp;--border-background-feature-card-selected:<b className="afterColon">{dataRef.text_highlight};</b></p>
