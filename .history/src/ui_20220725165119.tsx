...
function App() {
  ...
  return(
    ...
    <p className="help">
This plugin is designed to work with the <a></a>Eluvio Marketplace Template Figma document. First, make a copy of the document and configure the marketplace styling however you’d like. Then, run the plugin and click “Stylesheet” to generate SCSS variables which can be directly plugged into the Eluvio fabric browser to style your live marketplace. If you have any further questions, the plugin source code can be found here and you can email us at events@live.eluv.io.
    </p>
