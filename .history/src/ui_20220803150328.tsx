...
function App() {
  ...
  const onResetTheme = (theme) => {
    if(theme == "dark") {
      parent.postMessage({ pluginMessage: { type: "setToDark" } }, "*");
    } else if(theme == "light") {
      parent.postMessage({ pluginMessage: { type: "setToLight" } }, "*");
    }
  }
      ...
      <main>
        ...
        <div className="spacer" />
         ...
         <button className="brand" onClick={onStylesheet}>
          ...
          <div className="spacer" />
          <button className="brand" onClick={()=>onResetTheme("dark")}>
            Dark Theme
          </button>
          <div className="spacer" />
    ...
    return(
        <div className="stylesheet">
          ...
          <div className="text"> 
            ...
            <p>&ensp;--color-button-primary-text:<b className="afterColon">{dataRef.text_highlight};</b></p>
